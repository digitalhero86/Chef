...
echo "Downloading and installing Chef DK package..."
...
Vagrant.configure(2) do |config|
  ...
  config.vm.define 'workstation-ubuntu' do |w|
    w.vm.box = 'bento/ubuntu-14.04'
    w.vm.box_version = '2.2.9'
    w.vm.hostname = 'workstation-ubuntu'
    w.vm.network 'private_network', ip: '10.1.1.35'
    w.vm.provision :shell, inline: CHEF_WORKSTATION_SCRIPT.dup
    set_hostname(w)
  end
end
